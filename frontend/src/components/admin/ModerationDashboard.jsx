...
export const ModerationDashboard = () => {
  ...
  return <div className="admin-shell" data-testid="moderation-dashboard">
    <header className="admin-header"><div className="admin-title"><img src="/abdsi_logo.png" alt="ABDSI Logo" className="brand-logo" /><div><b>Pusat Moderasi</b><small>HARNAS UMKM • ABDSI 2026</small></div></div><div className="admin-header-actions"><a href="/" target="_blank" data-testid="admin-view-portal-link">Lihat portal <ExternalLink/></a><button onClick={logout} data-testid="admin-logout-button"><LogOut/> Keluar</button></div></header>
